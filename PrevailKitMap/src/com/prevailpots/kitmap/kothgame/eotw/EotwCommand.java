package com.prevailpots.kitmap.kothgame.eotw;
...
public class EotwCommand implements CommandExecutor, TabCompleter {
    ...
    private static final class EotwPrompt extends StringPrompt {
        public String getPromptText(final ConversationContext context) {
            return ChatColor.YELLOW + "Are you sure you want to do this? If EOTW mode is active, all claims will be deleted whilst making Spawn a KOTH. " + "You will still have " + EOTWHandler.EOTW_WARMUP_WAIT_SECONDS + " seconds to cancel this using the same command. " + "Type " + ChatColor.GREEN + "yes" + ChatColor.YELLOW + " to confirm or " + ChatColor.RED + "no" + ChatColor.YELLOW + " to deny.";
        }
