...
public class GameRenameArgument extends CommandArgument {
    ...
    public GameRenameArgument(final HCF plugin) {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "Renamed event " + ChatColor.GOLD + oldName + ChatColor.YELLOW + " to " + ChatColor.GOLD + faction.getName() + ChatColor.YELLOW + '.');
        return true;
    }
