...
import com.prevailpots.kitmap.faction.event.FactionChatEvent;
import com.prevailpots.kitmap.faction.event.FactionRemoveEvent;
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if(args[1].equalsIgnoreCase("list")) {
            ...
            if(currentSpies.add(faction.getUniqueID())) {
                plugin.getUserManager().getUser(player.getUniqueId()).getFactionChatSpying().add(faction.getUniqueID());
            ...
            if(faction == null) {
                sender.sendMessage(ChatColor.GOLD + "Faction '" + ChatColor.YELLOW + args[2] + ChatColor.GOLD + "' not found.");
                return true;
            }
