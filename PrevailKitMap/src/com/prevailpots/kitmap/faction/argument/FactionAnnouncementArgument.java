...
public class FactionAnnouncementArgument extends CommandArgument
{
    ...
    public FactionAnnouncementArgument(final HCF plugin) {
        super("announcement", "Set your faction's announcement.", new String[] { "announce" });
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        if (newAnnouncement == null) {
            playerFaction.broadcast(ChatColor.GREEN + sender.getName() + ChatColor.YELLOW + " has cleared the factions' announcement.");
            return true;
        }
