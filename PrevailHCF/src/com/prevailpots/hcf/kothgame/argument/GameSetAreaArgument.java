...
public class GameSetAreaArgument extends CommandArgument {
    ...
    public GameSetAreaArgument(final HCF plugin) {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "Updated the claim for event " + ChatColor.GOLD  + faction.getName() + ChatColor.YELLOW + '.');
        return true;
    }
